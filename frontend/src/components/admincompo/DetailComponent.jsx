...
function DetailComponent({ user, setUsers }) {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1 flex flex-col items-center">
                            <div className="relative">
                                {displayUser.profileimage_url ? (
                                    <img 
                                        src={displayUser.profileimage_url} 
                                        alt="Profile" 
                                ...
                                <div className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-full border-4 border-white flex items-center justify-center ${
                                    displayUser.is_active ? 'bg-green-500' : 'bg-red-500'
                                }`}>
                            ...
                            <div className="mt-6 flex flex-col gap-2">
                                <span className={`px-4 py-2 rounded-full text-sm font-semibold text-center ${
                                    ...
                                    {displayUser.is_active ? 'Active Account' : 'Inactive Account'}
                                </span>
                                
                                {displayUser.is_blocked && (
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-purple-300/10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-white text-lg font-semibold">{displayUser.name}</p>
                                    </div>
                                    <div className="space-y-1">
                                        <label className="text-sm text-purple-300 font-medium">User Type</label>
                                        <p className="text-white text-lg capitalize font-semibold">{displayUser.user_type}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-purple-300/10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-white text-lg">{displayUser.phone || 'Not provided'}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 rounded-xl p-6 border border-purple-300/10">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-white text-lg font-mono">#{displayUser.id}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
